...
shinyUI(fluidPage(
    navbarPage("BSGN Insurance",
               # Third Main-Tab-------------
               tabPanel("Premium Calculator", "Calculate your personalized premium!"),
                        tabsetPanel(
...
#pol = policy
# "pol_coverageMedian1"   "pol_coverageMedian2"   "pol_coverageMini"     
# "pol_usageProfessional" "pol_usageRetired"      "pol_usageWorkPrivate" 
# "drv_sex1M"             "drv_age_lic1"          "vh_din"               
